...
-(instancetype) initWithHandle:(NSString*)handle
    ...
    person.userName = userRandString; //WF: this is temporary so the database has unique usernames
    ...
    person.accessToken = [pearingStorage objectForKey:@"PEInstagramService_AccessToken"]; //we have to have the access token not sure what the best route is for this. 
